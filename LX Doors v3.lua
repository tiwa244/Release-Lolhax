...
function Esp(Parent, TextAdornee, Text, Color, OutlineColor, Type)
    ...
    { FillTransparency = (Toggles.ESPI_M_Enabled.Value and Toggles.ESPI_M_Fill.Value and Options.ESPS_FillTransparency.Value or 1) }
):Play()

game:GetService("TweenService"):Create(
    Highlight,
    TweenInfo.new(Options.ESPS_FadeTime.Value),
    { OutlineTransparency = (Toggles.ESPI_M_Enabled.Value and Toggles.ESPI_M_Outline.Value and Options.ESPS_OutlineTransparency.Value or 1) }
):Play()

...
local CustomColors = {}
local Items = {
    {Tag="Doors", Text="Door", Color=Color3.fromRGB(0,255,127), Color2=Color3.new(1,1,1), Color4=Color3.fromRGB(0,230,127)},
    ...
    {Tag="LibraryBooks", Text="Library Book", Color=Color3.fromRGB(0,255,127), Color2=Color3.new(1,1,1), Color4=Color3.fromRGB(0,230,127)},
    ...
    {Tag="Closet", Text="Closet", Color=Color3.fromRGB(0,255,127), Color2=Color3.new(1,1,1), Color4=Color3.fromRGB(0,230,127)},
...
local Connections = {
    ...
    LocalPlayer:GetAttributeChangedSignal("CurrentRoom"):Connect(function()
	 ...
	 Library:Notify("CurrentRoom's Room is: ", tostring(Rooms[LocalPlayer:GetAttribute("CurrentRoom")])

...
local Items = {
    ...
    {Tag="GeneratorFuses", Text="Generator Fuse", Color=Color3.fromRGB(0,255,127), Color2=Color3.new(1,1,1), Color4=Color3.fromRGB(0,100,50), NewColor=Color3.fromRGB(0,255,127), NewColor2=Color3.fromRGB(0,255,127), NewColor3=Color3.fromRGB(0,255,127)},
    {Tag="Generators", Text="Generator", Color=Color3.fromRGB(0,255,127), Color2=Color3.new(1,1,1), Color4=Color3.fromRGB(0,100,50), NewColor=Color3.fromRGB(0,255,127), NewColor2=Color3.fromRGB(0,255,127), NewColor3=Color3.fromRGB(0,255,127)},
    {Tag="GateLevers", Text="Gate Lever", Color=Color3.new(1,1,1), NoText=false, Color2=Color3.new(1,1,1), Color4=Color3.new(1,1,1)},
    {Tag="LibraryBooks", Text="Library Book", Color=Color3.fromRGB(0,255,127), Color2=Color3.new(1,1,1), Color4=Color3.fromRGB(0,100,50)},
    ...
    {Tag="Closet", Text="Closet", Color=Color3.fromRGB(0,255,127), Color2=Color3.new(1,1,1), Color4=Color3.fromRGB(0,100,50)},

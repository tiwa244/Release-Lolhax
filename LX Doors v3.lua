...
GeneralAutomation:AddDropdown("GA_AutoBreakerAutoSolveOption", { Text = "Automatic Breaker Solve Options", Values = { "Legit", "Exploit" }, Default = "Legit", Disabled = not Script.IsHotel, DisabledTooltip = "This feature is not for this floor, or doesn't work anymore.", Tooltip = "Automatic Breaker Solve Options.", Multi = false })
GeneralAutomation:AddDivider()

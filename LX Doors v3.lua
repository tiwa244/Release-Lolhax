...
ExploitSelf:AddToggle("ES_AntiSnare", { Text = "Anti-Snare", Default = false, Tooltip = "Disallows touching on the entity 'Snare'.", Visible = Script.FloorVal.Value == "Garden" or Script.IsHotel, DisabledTooltip = "This feature is not for this floor, or doesn't work anymore." })
...
ExploitBypass:AddToggle("EB_TheMinesAnticheatBypass", { Text = "Anticheat Bypass", Default = false, Tooltip = "Disables Anticheat in Mines.", Visible = Script.IsMines or Script.IsBattle, DisabledTooltip = "This feature is not for this floor, or doesn't work anymore." })  
